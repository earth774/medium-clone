...
- Database models: Article (statusId: 1=published, 2=draft), Category, User, ArticleLike - No Follow model exists
...
- Main pages: Home at `web/app/page.tsx`, Write at `web/app/write/page.tsx`, Article detail at `web/app/articles/[id]/page.tsx`
